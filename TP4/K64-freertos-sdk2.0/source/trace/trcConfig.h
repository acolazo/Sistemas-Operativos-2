 ...
 * TRC_FREERTOS_VERSION_9_0_2					If using FreeRTOS v9.0.2 or later
 *****************************************************************************/
 ...
 *
 * We recommend users of Tracealyzer Free Edition to use this option (= 1) to
 * avoid storing other events, that are not displayed in Free Edition anyway.
 *
 ...
 * Macro which should be defined as either zero (0) or one (1).
 *
 * If this is zero (0), the trace will exclude any "task notify" events.
 *
 * Default value is 1 (included).
 *****************************************************************************/
#define TRC_CFG_INCLUDE_NOTIFY_EVENTS 1
